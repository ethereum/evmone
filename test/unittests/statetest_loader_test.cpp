...
{
    const TestState state{{0xadd4_address, {.code = "EF0001010000020001000103000100FEDA"_hex}}};
...
{
    const TestState state{{0xadd4_address, {.code = "EF00"_hex}}};
...
{
    const TestState state{{0xadd4_address, {.storage = {{0x01_bytes32, 0x00_bytes32}}}}};
    EXPECT_THAT([&] { validate_state(state, EVMC_PRAGUE); },
        ThrowsMessage<std::invalid_argument>(
