...
TEST_F(execution, solidity_abi_decoder)
{
    rev = EVMC_HOMESTEAD;
    auto code = "";
    auto input = "26121ff0";
    execute(code, input);
    EXPECT_EQ(result.status_code, EVMC_SUCCESS);
    EXPECT_EQ(result.output_size, 32);
    EXPECT_EQ(result.output_data[31], '\x01');
}