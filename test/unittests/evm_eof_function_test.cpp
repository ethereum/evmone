...
TEST_P(evm, minimal_jumpf)
{
    ...
    rev = EVMC_PRAGUE;
    const auto code = bytecode{"ef0001 010008 020002 0003 0001 040000 00 00000000 00000000"_hex} +
...
TEST_P(evm, jumpf_to_returning_function)
{
    ...
    rev = EVMC_PRAGUE;
    const auto code =
        bytecode{"ef0001 01000c 020003 0009 0005 0004 040000 00 00000002 00010001 01010002"_hex} +
        // function 0
...
TEST_P(evm, jumpf_to_function_with_fewer_outputs)
{
    ...
    rev = EVMC_PRAGUE;
    const auto code =
        bytecode{"ef0001 01000c 020003 0009 0007 0004 040000 00 00000003 00020002 01010002"_hex} +
        // function 0
        OP_CALLF + "0001" + OP_PUSH0 + OP_MSTORE + OP_PUSH1 + "20" + OP_PUSH0 + OP_RETURN +
