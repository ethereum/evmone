...
TEST(state_mpt_hash, pre_byzantium_receipt)
{
    ...
    receipt0.type = evmone::state::Transaction::Type::legacy;
    receipt0.post_state =
        0x4a8f9db452b100f9ec85830785b2d1744c3e727561c334c4f18022daa113290a_bytes32;
    receipt0.cumulative_gas_used = 0x8323;
    receipt0.logs_bloom_filter = compute_bloom_filter(receipt0.logs);

    TransactionReceipt receipt1{};
    receipt1.type = evmone::state::Transaction::Type::legacy;
    receipt1.post_state =
        0xb14ab7c32b3e126591731850976a15e2359c1f3628f1b0ff37776c210b9cadb8_bytes32;
    receipt1.cumulative_gas_used = 0x10646;
    receipt1.logs_bloom_filter = compute_bloom_filter(receipt1.logs);

    TransactionReceipt receipt2{};
    receipt2.type = evmone::state::Transaction::Type::legacy;
    receipt2.post_state =
        0x7bda915deb201cae321d31028d322877e8fb98264db3ffcbfec7ea7b9b2106b1_bytes32;
    receipt2.cumulative_gas_used = 0x1584e;
    receipt2.logs_bloom_filter = compute_bloom_filter(receipt2.logs);
