...
{
[[gnu::always_inline]]
static uint64_t rotr(uint64_t x, unsigned r)
{
    return (x >> r) | (x << (64 - r));
}
...
[[clang::no_sanitize("coverage"), clang::no_sanitize("undefined"), gnu::always_inline]]
static void g(
...
[[clang::no_sanitize("coverage"), clang::no_sanitize("address"), clang::no_sanitize("undefined"),
    clang::no_sanitize("pointer-overflow")]]
