...
template <> constexpr auto impl<OP_CREATE> = create<EVMC_CREATE>;
template <> constexpr auto impl<OP_CALL> = call<EVMC_CALL>;
template <> constexpr auto impl<OP_CALLCODE> = call<EVMC_CALLCODE>;
template <> constexpr auto impl<OP_RETURN> = return_<EVMC_SUCCESS>;
template <> constexpr auto impl<OP_DELEGATECALL> = call<EVMC_DELEGATECALL>;
template <> constexpr auto impl<OP_CREATE2> = create<EVMC_CREATE2>;
template <> constexpr auto impl<OP_STATICCALL> = call<EVMC_CALL, true>;
