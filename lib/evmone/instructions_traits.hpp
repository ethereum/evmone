...
constexpr inline std::array<Traits, 256> traits = []() noexcept {
    ...
    table[OP_CALL2] = {"CALL2", 0, false, 4, -3, EVMC_PRAGUE};
    table[OP_DELEGATECALL2] = {"DELEGATECALL2", 0, false, 3, -2, EVMC_PRAGUE};
    table[OP_STATICCALL] = {"STATICCALL", 0, false, 6, -5, EVMC_BYZANTIUM};
    table[OP_STATICCALL2] = {"STATICCALL2", 0, false, 3, -2, EVMC_PRAGUE};
