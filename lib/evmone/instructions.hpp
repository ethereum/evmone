...
inline constexpr auto extcall = newcall_impl<OP_EXTCALL>;
inline constexpr auto extdelegatecall = newcall_impl<OP_EXTDELEGATECALL>;
inline constexpr auto extstaticcall = newcall_impl<OP_EXTSTATICCALL>;
