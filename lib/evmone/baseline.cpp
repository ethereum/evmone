...
[[gnu::always_inline]] inline code_iterator invoke(
    void (*instr_fn)(uint256*), ExecutionState& state, code_iterator pos) noexcept
{
...
[[gnu::always_inline]] inline code_iterator invoke(
    StopToken (*instr_fn)(), ExecutionState& state, code_iterator /*pos*/) noexcept
{
...
[[gnu::always_inline]] inline code_iterator invoke(
    evmc_status_code (*instr_fn)(uint256*, ExecutionState&), ExecutionState& state,
...
[[gnu::always_inline]] inline code_iterator invoke(
    void (*instr_fn)(uint256*, ExecutionState&), ExecutionState& state, code_iterator pos) noexcept
{
...
[[gnu::always_inline]] inline code_iterator invoke(
    code_iterator (*instr_fn)(uint256*, ExecutionState&, code_iterator), ExecutionState& state,
    code_iterator pos) noexcept
{
